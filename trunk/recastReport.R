...
normal<-read.table("normalLets.col.txt",header=FALSE,col.names=c("miRNA","pos","ref","var","refnorm","revrefnorm","varnorm","revvarnorm"))
#normal$cell<-"normal"
tumor<-read.table("tumorLets.col.txt",header=FALSE,col.names=c("miRNA","pos","ref","var","reftumor","revreftumor","vartumor","revvartumor"))
#tumor$cell<-"tumor"
...
print(res)
write.csv(res,file="hsa-let.edits.fisher.csv")