...
bamView<-BamViews(bamPaths=bamPaths,bamSamples=bamSamples)
...
\begin{itemize}
  ...
  \item Illumina IIfx
    ...
    \begin{enumerate}
    \item WERI01\_PGM \Sexpr{formatC(bamcounts$WERI01_PGM$records, format="d", big.mark=',')} alignments
    \item WERI02\_PGM \Sexpr{formatC(bamcounts$WERI02_PGM$records, format="d", big.mark=',')} alignments
    \item WERI03\_PGM \Sexpr{formatC(bamcounts$WERI03_PGM$records, format="d", big.mark=',')} alignments
    \item RB525T01\_PGM \Sexpr{formatC(bamcounts$RB525T01_PGM$records, format="d", big.mark=',')} alignments
    \item RB525T02\_PGM \Sexpr{formatC(bamcounts$RB525T02_PGM$records, format="d", big.mark=',')} alignments
    \item RB525T03\_PGM \Sexpr{formatC(bamcounts$RB525T03_PGM$records, format="d", big.mark=',')} alignments
    \end{enumerate}
    \end{itemize}  
